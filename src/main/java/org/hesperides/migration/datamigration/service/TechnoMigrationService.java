...
import org.hesperides.migration.datamigration.legacy.events.technos.LegacyTechnoDeletedEvent;
import org.hesperides.migration.datamigration.legacy.events.technos.LegacyTechnoTemplateCreatedEvent;
import org.hesperides.migration.datamigration.legacy.events.technos.LegacyTechnoTemplateDeletedEvent;
import org.hesperides.migration.datamigration.legacy.events.technos.LegacyTechnoTemplateUpdatedEvent;
            ...
            try {
                ...
                if (shouldCreateTechno.get()) {
                    ...
                    domainEventMessages.add(new GenericDomainEventMessage<>(
                            ...
                            new GenericEventMessage<>(new TechnoCreatedEvent(new Techno(legacyInterface.getKey(), new ArrayList<>()), user)),
                            supplier));
